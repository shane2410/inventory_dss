...
urlpatterns = [
    ...
    path('planning/overview/', planning_overview, name='planning-overview'),
    path('planning/overview/excel/', planning_report_excel_api, name='planning-report-excel-api'),
    ...
    path('product-decomposition/', product_decomposition, name='product-decomposition-root'),
    path('disaggregate-plan/', product_decomposition, name='disaggregate_plan_root'),
    ...
    path('api/mps/run/', run_mps_api, name='run-mps-api'),
